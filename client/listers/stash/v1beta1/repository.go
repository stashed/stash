...
type RepositoryLister interface {
	...
	List(selector labels.Selector) (ret []*v1beta1.Repository, err error)
...
// List lists all Repositories in the indexer.
func (s *repositoryLister) List(selector labels.Selector) (ret []*v1beta1.Repository, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1beta1.Repository))
	})
	return ret, err
}
...
type RepositoryNamespaceLister interface {
	...
	Get(name string) (*v1beta1.Repository, error)
...
// List lists all Repositories in the indexer for a given namespace.
func (s repositoryNamespaceLister) List(selector labels.Selector) (ret []*v1beta1.Repository, err error) {
...
// Get retrieves the Repository from the indexer for a given namespace and name.
func (s repositoryNamespaceLister) Get(name string) (*v1beta1.Repository, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1beta1.Resource("repository"), name)
	}
	return obj.(*v1beta1.Repository), nil
}
