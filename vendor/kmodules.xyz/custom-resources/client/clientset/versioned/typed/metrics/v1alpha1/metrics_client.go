...
type MetricsV1alpha1Interface interface {
	...
	MetricsConfigurationsGetter
}

// MetricsV1alpha1Client is used to interact with features provided by the metrics.appscode.com group.
type MetricsV1alpha1Client struct {
	restClient rest.Interface
}

func (c *MetricsV1alpha1Client) MetricsConfigurations() MetricsConfigurationInterface {
	return newMetricsConfigurations(c)
}
