...
**Helm:**
```console
$ helm install appscode/stash --name stash-operator --version 0.7.0 --name=stash-operator --set monitoring.agent=builtin --set monitoring.backup=true --set monitoring.operator=true
```
