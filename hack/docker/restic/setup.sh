...
build() {
	...
	wget https://github.com/restic/restic/releases/download/v$RESTIC_VER/restic_$RESTIC_VER_linux_amd64.bz2
	bzip2 -d restic_$RESTIC_VER_linux_amd64.bz2
	mv restic_$RESTIC_VER_linux_amd64 restic
