...
const (
	// ----- content types ----
	codecSelferC_UTF83474 = 1
	codecSelferC_RAW3474  = 0
	// ----- value types used ----
	codecSelferValueTypeArray3474 = 10
	codecSelferValueTypeMap3474   = 9
	// ----- containerStateValues ----
	codecSelfer_containerMapKey3474    = 2
	codecSelfer_containerMapValue3474  = 3
	codecSelfer_containerMapEnd3474    = 4
	codecSelfer_containerArrayElem3474 = 6
	codecSelfer_containerArrayEnd3474  = 7
)

var (
	codecSelferBitsize3474                         = uint8(reflect.TypeOf(uint(0)).Bits())
	codecSelferOnlyMapOrArrayEncodeToStructErr3474 = errors.New(`only encoded map or array can be decoded into a struct`)
)

type codecSelfer3474 struct{}
...
func (x *Restic) CodecEncodeSelf(e *codec1978.Encoder) {
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				z.EncSendContainerState(codecSelfer_containerArrayElem3474)
				if yyq2[0] {
					yym4 := z.EncBinary()
					_ = yym4
					if false {
					} else {
						r.EncodeString(codecSelferC_UTF83474, string(x.Kind))
					}
				} else {
					r.EncodeString(codecSelferC_UTF83474, "")
				}
			} else {
				if yyq2[0] {
					z.EncSendContainerState(codecSelfer_containerMapKey3474)
					r.EncodeString(codecSelferC_UTF83474, string("kind"))
					z.EncSendContainerState(codecSelfer_containerMapValue3474)
					yym5 := z.EncBinary()
					_ = yym5
					if false {
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[1] {
					...
					if false {
						...
						r.EncodeString(codecSelferC_UTF83474, string(x.APIVersion))
					}
				} else {
					r.EncodeString(codecSelferC_UTF83474, "")
				}
				...
				if yyq2[1] {
					z.EncSendContainerState(codecSelfer_containerMapKey3474)
					r.EncodeString(codecSelferC_UTF83474, string("apiVersion"))
					z.EncSendContainerState(codecSelfer_containerMapValue3474)
					yym8 := z.EncBinary()
					_ = yym8
					if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[2] {
					z.EncSendContainerState(codecSelfer_containerMapKey3474)
					r.EncodeString(codecSelferC_UTF83474, string("metadata"))
					z.EncSendContainerState(codecSelfer_containerMapValue3474)
					yy12 := &x.ObjectMeta
					yym13 := z.EncBinary()
					_ = yym13
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[3] {
					z.EncSendContainerState(codecSelfer_containerMapKey3474)
					r.EncodeString(codecSelferC_UTF83474, string("spec"))
					z.EncSendContainerState(codecSelfer_containerMapValue3474)
					yy17 := &x.Spec
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[4] {
					z.EncSendContainerState(codecSelfer_containerMapKey3474)
					r.EncodeString(codecSelferC_UTF83474, string("status"))
					z.EncSendContainerState(codecSelfer_containerMapValue3474)
					yy22 := &x.Status
			...
			if yyr2 || yy2arr2 {
				z.EncSendContainerState(codecSelfer_containerArrayEnd3474)
			} else {
				z.EncSendContainerState(codecSelfer_containerMapEnd3474)
			}
		}
	}
}
...
func (x *Restic) CodecDecodeSelf(d *codec1978.Decoder) {
	...
	if false {
		...
		if yyct2 == codecSelferValueTypeMap3474 {
			yyl2 := r.ReadMapStart()
			if yyl2 == 0 {
				z.DecSendContainerState(codecSelfer_containerMapEnd3474)
			} else {
				x.codecDecodeSelfFromMap(yyl2, d)
			}
		} else if yyct2 == codecSelferValueTypeArray3474 {
			yyl2 := r.ReadArrayStart()
			if yyl2 == 0 {
				z.DecSendContainerState(codecSelfer_containerArrayEnd3474)
			} else {
				x.codecDecodeSelfFromArray(yyl2, d)
			}
		} else {
			panic(codecSelferOnlyMapOrArrayEncodeToStructErr3474)
		}
	}
}
...
func (x *Restic) codecDecodeSelfFromMap(l int, d *codec1978.Decoder) {
	...
	for yyj3 := 0; ; yyj3++ {
		...
		z.DecSendContainerState(codecSelfer_containerMapKey3474)
		yys3Slc = r.DecodeBytes(yys3Slc, true, true)
		yys3 := string(yys3Slc)
		z.DecSendContainerState(codecSelfer_containerMapValue3474)
		switch yys3 {
		case "kind":
			if r.TryDecodeAsNil() {
				x.Kind = ""
...
func (x *Restic) codecDecodeSelfFromArray(l int, d *codec1978.Decoder) {
	...
	z.DecSendContainerState(codecSelfer_containerArrayElem3474)
	if r.TryDecodeAsNil() {
		x.Kind = ""
	} else {
		yyv13 := &x.Kind
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[0] {
					z.EncSendContainerState(codecSelfer_containerMapKey3474)
					r.EncodeString(codecSelferC_UTF83474, string("selector"))
					z.EncSendContainerState(codecSelfer_containerMapValue3474)
					yy6 := &x.Selector
					yym7 := z.EncBinary()
					_ = yym7
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[1] {
					z.EncSendContainerState(codecSelfer_containerMapKey3474)
					r.EncodeString(codecSelferC_UTF83474, string("fileGroups"))
					z.EncSendContainerState(codecSelfer_containerMapValue3474)
					if x.FileGroups == nil {
						r.EncodeNil()
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[2] {
					z.EncSendContainerState(codecSelfer_containerMapKey3474)
					r.EncodeString(codecSelferC_UTF83474, string("backend"))
					z.EncSendContainerState(codecSelfer_containerMapValue3474)
					yy14 := &x.Backend
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[3] {
					...
					if false {
						...
						r.EncodeString(codecSelferC_UTF83474, string(x.Schedule))
					}
				} else {
					r.EncodeString(codecSelferC_UTF83474, "")
				}
				...
				if yyq2[3] {
					z.EncSendContainerState(codecSelfer_containerMapKey3474)
					r.EncodeString(codecSelferC_UTF83474, string("schedule"))
					z.EncSendContainerState(codecSelfer_containerMapValue3474)
					yym18 := z.EncBinary()
					_ = yym18
					if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[4] {
					z.EncSendContainerState(codecSelfer_containerMapKey3474)
					r.EncodeString(codecSelferC_UTF83474, string("useAutoPrefix"))
					z.EncSendContainerState(codecSelfer_containerMapValue3474)
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[5] {
					z.EncSendContainerState(codecSelfer_containerMapKey3474)
					r.EncodeString(codecSelferC_UTF83474, string("volumeMounts"))
					z.EncSendContainerState(codecSelfer_containerMapValue3474)
					if x.VolumeMounts == nil {
						r.EncodeNil()
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[6] {
					z.EncSendContainerState(codecSelfer_containerMapKey3474)
					r.EncodeString(codecSelferC_UTF83474, string("resources"))
					z.EncSendContainerState(codecSelfer_containerMapValue3474)
					yy28 := &x.Resources
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[0] {
					z.EncSendContainerState(codecSelfer_containerMapKey3474)
					r.EncodeString(codecSelferC_UTF83474, string("firstBackupTime"))
					z.EncSendContainerState(codecSelfer_containerMapValue3474)
					if x.FirstBackupTime == nil {
						r.EncodeNil()
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[1] {
					z.EncSendContainerState(codecSelfer_containerMapKey3474)
					r.EncodeString(codecSelferC_UTF83474, string("lastBackupTime"))
					z.EncSendContainerState(codecSelfer_containerMapValue3474)
					if x.LastBackupTime == nil {
						r.EncodeNil()
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[2] {
					z.EncSendContainerState(codecSelfer_containerMapKey3474)
					r.EncodeString(codecSelferC_UTF83474, string("lastSuccessfulBackupTime"))
					z.EncSendContainerState(codecSelfer_containerMapValue3474)
					if x.LastSuccessfulBackupTime == nil {
						r.EncodeNil()
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[3] {
					...
					if false {
						...
						r.EncodeString(codecSelferC_UTF83474, string(x.LastBackupDuration))
					}
				} else {
					r.EncodeString(codecSelferC_UTF83474, "")
				}
				...
				if yyq2[3] {
					z.EncSendContainerState(codecSelfer_containerMapKey3474)
					r.EncodeString(codecSelferC_UTF83474, string("lastBackupDuration"))
					z.EncSendContainerState(codecSelfer_containerMapValue3474)
					yym14 := z.EncBinary()
					_ = yym14
					if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[4] {
					z.EncSendContainerState(codecSelfer_containerMapKey3474)
					r.EncodeString(codecSelferC_UTF83474, string("backupCount"))
					z.EncSendContainerState(codecSelfer_containerMapValue3474)
					yym17 := z.EncBinary()
					_ = yym17
					if false {
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[3] {
					z.EncSendContainerState(codecSelfer_containerMapKey3474)
					r.EncodeString(codecSelferC_UTF83474, string("items"))
					z.EncSendContainerState(codecSelfer_containerMapValue3474)
					if x.Items == nil {
						r.EncodeNil()
					} else {
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[0] {
					...
					if false {
						...
						r.EncodeString(codecSelferC_UTF83474, string(x.Path))
					}
				} else {
					r.EncodeString(codecSelferC_UTF83474, "")
				}
				...
				if yyq2[0] {
					z.EncSendContainerState(codecSelfer_containerMapKey3474)
					r.EncodeString(codecSelferC_UTF83474, string("path"))
					z.EncSendContainerState(codecSelfer_containerMapValue3474)
					yym5 := z.EncBinary()
					_ = yym5
					if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[1] {
					z.EncSendContainerState(codecSelfer_containerMapKey3474)
					r.EncodeString(codecSelferC_UTF83474, string("tags"))
					z.EncSendContainerState(codecSelfer_containerMapValue3474)
					if x.Tags == nil {
						r.EncodeNil()
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[2] {
					z.EncSendContainerState(codecSelfer_containerMapKey3474)
					r.EncodeString(codecSelferC_UTF83474, string("retentionPolicy"))
					z.EncSendContainerState(codecSelfer_containerMapValue3474)
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[0] {
					...
					if false {
						...
						r.EncodeString(codecSelferC_UTF83474, string(x.StorageSecretName))
					}
				} else {
					r.EncodeString(codecSelferC_UTF83474, "")
				}
				...
				if yyq2[0] {
					z.EncSendContainerState(codecSelfer_containerMapKey3474)
					r.EncodeString(codecSelferC_UTF83474, string("storageSecretName"))
					z.EncSendContainerState(codecSelfer_containerMapValue3474)
					yym5 := z.EncBinary()
					_ = yym5
					if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[1] {
					z.EncSendContainerState(codecSelfer_containerMapKey3474)
					r.EncodeString(codecSelferC_UTF83474, string("local"))
					z.EncSendContainerState(codecSelfer_containerMapValue3474)
					if x.Local == nil {
						r.EncodeNil()
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[2] {
					z.EncSendContainerState(codecSelfer_containerMapKey3474)
					r.EncodeString(codecSelferC_UTF83474, string("s3"))
					z.EncSendContainerState(codecSelfer_containerMapValue3474)
					if x.S3 == nil {
						r.EncodeNil()
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[3] {
					z.EncSendContainerState(codecSelfer_containerMapKey3474)
					r.EncodeString(codecSelferC_UTF83474, string("gcs"))
					z.EncSendContainerState(codecSelfer_containerMapValue3474)
					if x.GCS == nil {
						r.EncodeNil()
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[4] {
					z.EncSendContainerState(codecSelfer_containerMapKey3474)
					r.EncodeString(codecSelferC_UTF83474, string("azure"))
					z.EncSendContainerState(codecSelfer_containerMapValue3474)
					if x.Azure == nil {
						r.EncodeNil()
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[5] {
					z.EncSendContainerState(codecSelfer_containerMapKey3474)
					r.EncodeString(codecSelferC_UTF83474, string("swift"))
					z.EncSendContainerState(codecSelfer_containerMapValue3474)
					if x.Swift == nil {
						r.EncodeNil()
					} else {
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[0] {
					z.EncSendContainerState(codecSelfer_containerMapKey3474)
					r.EncodeString(codecSelferC_UTF83474, string("volumeSource"))
					z.EncSendContainerState(codecSelfer_containerMapValue3474)
					yy6 := &x.VolumeSource
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[0] {
					...
					if false {
						...
						r.EncodeString(codecSelferC_UTF83474, string(x.Endpoint))
					}
				} else {
					r.EncodeString(codecSelferC_UTF83474, "")
				}
				...
				if yyq2[0] {
					z.EncSendContainerState(codecSelfer_containerMapKey3474)
					r.EncodeString(codecSelferC_UTF83474, string("endpoint"))
					z.EncSendContainerState(codecSelfer_containerMapValue3474)
					yym5 := z.EncBinary()
					_ = yym5
					if false {
			...
			if yyr2 || yy2arr2 {
				...
				if false {
					...
					r.EncodeString(codecSelferC_UTF83474, string(x.Bucket))
				}
			} else {
				z.EncSendContainerState(codecSelfer_containerMapKey3474)
				r.EncodeString(codecSelferC_UTF83474, string("bucket"))
				z.EncSendContainerState(codecSelfer_containerMapValue3474)
				yym8 := z.EncBinary()
				_ = yym8
				if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[2] {
					...
					if false {
						...
						r.EncodeString(codecSelferC_UTF83474, string(x.Prefix))
					}
				} else {
					r.EncodeString(codecSelferC_UTF83474, "")
				}
				...
				if yyq2[2] {
					z.EncSendContainerState(codecSelfer_containerMapKey3474)
					r.EncodeString(codecSelferC_UTF83474, string("prefix"))
					z.EncSendContainerState(codecSelfer_containerMapValue3474)
					yym11 := z.EncBinary()
					_ = yym11
					if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[0] {
					...
					if false {
						...
						r.EncodeString(codecSelferC_UTF83474, string(x.Container))
					}
				} else {
					r.EncodeString(codecSelferC_UTF83474, "")
				}
				...
				if yyq2[0] {
					z.EncSendContainerState(codecSelfer_containerMapKey3474)
					r.EncodeString(codecSelferC_UTF83474, string("container"))
					z.EncSendContainerState(codecSelfer_containerMapValue3474)
					yym5 := z.EncBinary()
					_ = yym5
					if false {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				if false {
					...
					r.EncodeString(codecSelferC_UTF83474, string(x.URL))
				}
			} else {
				z.EncSendContainerState(codecSelfer_containerMapKey3474)
				r.EncodeString(codecSelferC_UTF83474, string("url"))
				z.EncSendContainerState(codecSelfer_containerMapValue3474)
				yym5 := z.EncBinary()
				_ = yym5
				if false {
...
func (x RetentionStrategy) CodecEncodeSelf(e *codec1978.Encoder) {
	...
	if false {
		...
		r.EncodeString(codecSelferC_UTF83474, string(x))
	}
}
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[0] {
					z.EncSendContainerState(codecSelfer_containerMapKey3474)
					r.EncodeString(codecSelferC_UTF83474, string("keepLast"))
					z.EncSendContainerState(codecSelfer_containerMapValue3474)
					yym5 := z.EncBinary()
					_ = yym5
					if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[1] {
					z.EncSendContainerState(codecSelfer_containerMapKey3474)
					r.EncodeString(codecSelferC_UTF83474, string("keepHourly"))
					z.EncSendContainerState(codecSelfer_containerMapValue3474)
					yym8 := z.EncBinary()
					_ = yym8
					if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[2] {
					z.EncSendContainerState(codecSelfer_containerMapKey3474)
					r.EncodeString(codecSelferC_UTF83474, string("keepDaily"))
					z.EncSendContainerState(codecSelfer_containerMapValue3474)
					yym11 := z.EncBinary()
					_ = yym11
					if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[3] {
					z.EncSendContainerState(codecSelfer_containerMapKey3474)
					r.EncodeString(codecSelferC_UTF83474, string("keepWeekly"))
					z.EncSendContainerState(codecSelfer_containerMapValue3474)
					yym14 := z.EncBinary()
					_ = yym14
					if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[4] {
					z.EncSendContainerState(codecSelfer_containerMapKey3474)
					r.EncodeString(codecSelferC_UTF83474, string("keepMonthly"))
					z.EncSendContainerState(codecSelfer_containerMapValue3474)
					yym17 := z.EncBinary()
					_ = yym17
					if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[5] {
					z.EncSendContainerState(codecSelfer_containerMapKey3474)
					r.EncodeString(codecSelferC_UTF83474, string("keepYearly"))
					z.EncSendContainerState(codecSelfer_containerMapValue3474)
					yym20 := z.EncBinary()
					_ = yym20
					if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[6] {
					z.EncSendContainerState(codecSelfer_containerMapKey3474)
					r.EncodeString(codecSelferC_UTF83474, string("keepTags"))
					z.EncSendContainerState(codecSelfer_containerMapValue3474)
					if x.KeepTags == nil {
						r.EncodeNil()
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[7] {
					z.EncSendContainerState(codecSelfer_containerMapKey3474)
					r.EncodeString(codecSelferC_UTF83474, string("prune"))
					z.EncSendContainerState(codecSelfer_containerMapValue3474)
					yym26 := z.EncBinary()
					_ = yym26
					if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[8] {
					z.EncSendContainerState(codecSelfer_containerMapKey3474)
					r.EncodeString(codecSelferC_UTF83474, string("dryRun"))
					z.EncSendContainerState(codecSelfer_containerMapValue3474)
					yym29 := z.EncBinary()
					_ = yym29
					if false {
		...
		case "keepLast":
			if r.TryDecodeAsNil() {
				...
				if false {
					...
					*((*int)(yyv4)) = int(r.DecodeInt(codecSelferBitsize3474))
				}
			}
		case "keepHourly":
			if r.TryDecodeAsNil() {
				...
				if false {
					...
					*((*int)(yyv6)) = int(r.DecodeInt(codecSelferBitsize3474))
				}
			}
		case "keepDaily":
			if r.TryDecodeAsNil() {
				...
				if false {
					...
					*((*int)(yyv8)) = int(r.DecodeInt(codecSelferBitsize3474))
				}
			}
		case "keepWeekly":
			if r.TryDecodeAsNil() {
				...
				if false {
					...
					*((*int)(yyv10)) = int(r.DecodeInt(codecSelferBitsize3474))
				}
			}
		case "keepMonthly":
			if r.TryDecodeAsNil() {
				...
				if false {
					...
					*((*int)(yyv12)) = int(r.DecodeInt(codecSelferBitsize3474))
				}
			}
		case "keepYearly":
			if r.TryDecodeAsNil() {
				...
				if false {
					...
					*((*int)(yyv14)) = int(r.DecodeInt(codecSelferBitsize3474))
				}
			}
		case "keepTags":
			if r.TryDecodeAsNil() {
...
func (x *RetentionPolicy) codecDecodeSelfFromArray(l int, d *codec1978.Decoder) {
	...
	if r.TryDecodeAsNil() {
		...
		if false {
			...
			*((*int)(yyv23)) = int(r.DecodeInt(codecSelferBitsize3474))
		}
	}
	yyj22++
	if yyhl22 {
	...
	if r.TryDecodeAsNil() {
		...
		if false {
			...
			*((*int)(yyv25)) = int(r.DecodeInt(codecSelferBitsize3474))
		}
	}
	yyj22++
	if yyhl22 {
	...
	if r.TryDecodeAsNil() {
		...
		if false {
			...
			*((*int)(yyv27)) = int(r.DecodeInt(codecSelferBitsize3474))
		}
	}
	yyj22++
	if yyhl22 {
	...
	if r.TryDecodeAsNil() {
		...
		if false {
			...
			*((*int)(yyv29)) = int(r.DecodeInt(codecSelferBitsize3474))
		}
	}
	yyj22++
	if yyhl22 {
	...
	if r.TryDecodeAsNil() {
		...
		if false {
			...
			*((*int)(yyv31)) = int(r.DecodeInt(codecSelferBitsize3474))
		}
	}
	yyj22++
	if yyhl22 {
	...
	if r.TryDecodeAsNil() {
		...
		if false {
			...
			*((*int)(yyv33)) = int(r.DecodeInt(codecSelferBitsize3474))
		}
	}
	yyj22++
	if yyhl22 {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[4] {
					...
					if false {
						...
						r.EncodeString(codecSelferC_UTF83474, string(x.Status))
					}
				} else {
					r.EncodeString(codecSelferC_UTF83474, "")
				}
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[0] {
					...
					if false {
						...
						r.EncodeString(codecSelferC_UTF83474, string(x.Restic))
					}
				} else {
					r.EncodeString(codecSelferC_UTF83474, "")
				}
				...
				if yyq2[0] {
					z.EncSendContainerState(codecSelfer_containerMapKey3474)
					r.EncodeString(codecSelferC_UTF83474, string("restic"))
					z.EncSendContainerState(codecSelfer_containerMapValue3474)
					yym5 := z.EncBinary()
					_ = yym5
					if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[1] {
					z.EncSendContainerState(codecSelfer_containerMapKey3474)
					r.EncodeString(codecSelferC_UTF83474, string("volumes"))
					z.EncSendContainerState(codecSelfer_containerMapValue3474)
					if x.Volumes == nil {
						r.EncodeNil()
					} else {
		...
		case "volumes":
			if r.TryDecodeAsNil() {
				...
				if false {
					...
					h.decSlicev1_Volume((*[]pkg3_v1.Volume)(yyv6), d)
				}
			}
		default:
			z.DecStructFieldNotFound(-1, yys3)
...
func (x *RecoverySpec) codecDecodeSelfFromArray(l int, d *codec1978.Decoder) {
	...
	if r.TryDecodeAsNil() {
		...
		if false {
			...
			h.decSlicev1_Volume((*[]pkg3_v1.Volume)(yyv11), d)
		}
	}
	for {
		yyj8++
...
func (x codecSelfer3474) encSliceFileGroup(v []FileGroup, e *codec1978.Encoder) {
	var h codecSelfer3474
	z, r := codec1978.GenHelperEncoder(e)
	_, _, _ = h, z, r
...
func (x codecSelfer3474) decSliceFileGroup(v *[]FileGroup, d *codec1978.Decoder) {
	var h codecSelfer3474
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer3474) encSlicev1_VolumeMount(v []pkg3_v1.VolumeMount, e *codec1978.Encoder) {
	var h codecSelfer3474
	z, r := codec1978.GenHelperEncoder(e)
	_, _, _ = h, z, r
	r.EncodeArrayStart(len(v))
...
func (x codecSelfer3474) decSlicev1_VolumeMount(v *[]pkg3_v1.VolumeMount, d *codec1978.Decoder) {
	var h codecSelfer3474
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer3474) encSliceRestic(v []Restic, e *codec1978.Encoder) {
	var h codecSelfer3474
	z, r := codec1978.GenHelperEncoder(e)
	_, _, _ = h, z, r
	r.EncodeArrayStart(len(v))
...
func (x codecSelfer3474) decSliceRestic(v *[]Restic, d *codec1978.Decoder) {
	var h codecSelfer3474
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer3474) encSlicev1_Volume(v []pkg3_v1.Volume, e *codec1978.Encoder) {
	var h codecSelfer3474
	z, r := codec1978.GenHelperEncoder(e)
	_, _, _ = h, z, r
	r.EncodeArrayStart(len(v))
...
func (x codecSelfer3474) decSlicev1_Volume(v *[]pkg3_v1.Volume, d *codec1978.Decoder) {
	var h codecSelfer3474
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer3474) encSliceRecovery(v []Recovery, e *codec1978.Encoder) {
	var h codecSelfer3474
	z, r := codec1978.GenHelperEncoder(e)
	_, _, _ = h, z, r
	r.EncodeArrayStart(len(v))
...
func (x codecSelfer3474) decSliceRecovery(v *[]Recovery, d *codec1978.Decoder) {
	var h codecSelfer3474
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
