...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StashTask) DeepCopyInto(out *StashTask) {
	*out = *in
	out.TypeMeta = in.TypeMeta
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StashTask.
func (in *StashTask) DeepCopy() *StashTask {
	if in == nil {
		return nil
	}
	out := new(StashTask)
