...
func (*FormEntry) Descriptor() ([]byte, []int) { return fileDescriptorGenerated, []int{0} }

func (m *HTTPPostAction) Reset()                    { *m = HTTPPostAction{} }
func (*HTTPPostAction) ProtoMessage()               {}
func (*HTTPPostAction) Descriptor() ([]byte, []int) { return fileDescriptorGenerated, []int{1} }

func (m *Handler) Reset()                    { *m = Handler{} }
func (*Handler) ProtoMessage()               {}
func (*Handler) Descriptor() ([]byte, []int) { return fileDescriptorGenerated, []int{2} }
...
func (m *Handler) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.HTTPPost != nil {
		...
		n4, err := m.HTTPPost.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n4
	...
	if m.TCPSocket != nil {
		...
		n5, err := m.TCPSocket.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n5
...
func (this *HTTPPostAction) String() string {
	...
	s := strings.Join([]string{`&HTTPPostAction{`,
		...
		`Form:` + strings.Replace(strings.Replace(fmt.Sprintf("%v", this.Form), "FormEntry", "FormEntry", 1), `&`, ``, 1) + `,`,
		`}`,
	}, "")
	return s
}
