...
func schema_resource_metadata_apis_identity_v1alpha1_ClusterIdentityList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("kmodules.xyz/resource-metadata/apis/identity/v1alpha1.ClusterIdentity"),
									},
								},
							},
						},
...
func schema_resource_metadata_apis_identity_v1alpha1_InboxTokenRequest(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
				...
				Properties: map[string]spec.Schema{
					...
					"request": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref("kmodules.xyz/resource-metadata/apis/identity/v1alpha1.InboxTokenRequestRequest"),
						},
					},
					"response": {
						SchemaProps: spec.SchemaProps{
							Description: "Response describes the attributes for the graph response.",
							Ref:         ref("kmodules.xyz/resource-metadata/apis/identity/v1alpha1.InboxTokenRequestResponse"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"kmodules.xyz/resource-metadata/apis/identity/v1alpha1.InboxTokenRequestRequest", "kmodules.xyz/resource-metadata/apis/identity/v1alpha1.InboxTokenRequestResponse"},
	}
}

func schema_resource_metadata_apis_identity_v1alpha1_InboxTokenRequestRequest(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_resource_metadata_apis_identity_v1alpha1_InboxTokenRequestResponse(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_resource_metadata_apis_identity_v1alpha1_SelfSubjectNamespaceAccessReview(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							...
							Default:     map[string]interface{}{},
							Ref:         ref("kmodules.xyz/resource-metadata/apis/identity/v1alpha1.SelfSubjectNamespaceAccessReviewSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							...
							Default:     map[string]interface{}{},
							Ref:         ref("kmodules.xyz/resource-metadata/apis/identity/v1alpha1.SubjectAccessNamespaceReviewStatus"),
						},
					},
				},
				Required: []string{"spec"},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "kmodules.xyz/resource-metadata/apis/identity/v1alpha1.SelfSubjectNamespaceAccessReviewSpec", "kmodules.xyz/resource-metadata/apis/identity/v1alpha1.SubjectAccessNamespaceReviewStatus"},
	}
}

func schema_resource_metadata_apis_identity_v1alpha1_SelfSubjectNamespaceAccessReviewList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("kmodules.xyz/resource-metadata/apis/identity/v1alpha1.SelfSubjectNamespaceAccessReview"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "kmodules.xyz/resource-metadata/apis/identity/v1alpha1.SelfSubjectNamespaceAccessReview"},
	}
}

func schema_resource_metadata_apis_identity_v1alpha1_SelfSubjectNamespaceAccessReviewSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "SelfSubjectNamespaceAccessReviewSpec is a description of the access request.  Exactly one of ResourceAuthorizationAttributes and NonResourceAuthorizationAttributes must be set",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"resourceAttributes": {
						SchemaProps: spec.SchemaProps{
