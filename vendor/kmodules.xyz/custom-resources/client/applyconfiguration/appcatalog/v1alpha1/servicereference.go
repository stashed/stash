...
func (b *ServiceReferenceApplyConfiguration) WithScheme(value string) *ServiceReferenceApplyConfiguration {
	b.Scheme = &value
	return b
}
...
func (b *ServiceReferenceApplyConfiguration) WithQuery(value string) *ServiceReferenceApplyConfiguration {
	b.Query = &value
	return b
}
