...
func RegisterConversions(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedConversionFuncs(
		...
		Convert_v1alpha1_Backup_To_stash_Backup,
		Convert_stash_Backup_To_v1alpha1_Backup,
		Convert_v1alpha1_BackupList_To_stash_BackupList,
		Convert_stash_BackupList_To_v1alpha1_BackupList,
		Convert_v1alpha1_BackupSpec_To_stash_BackupSpec,
		Convert_stash_BackupSpec_To_v1alpha1_BackupSpec,
		Convert_v1alpha1_BackupStatus_To_stash_BackupStatus,
		Convert_stash_BackupStatus_To_v1alpha1_BackupStatus,
...
func autoConvert_v1alpha1_Backup_To_stash_Backup(in *Backup, out *stash.Backup, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	if err := Convert_v1alpha1_BackupSpec_To_stash_BackupSpec(&in.Spec, &out.Spec, s); err != nil {
		return err
	}
	if err := Convert_v1alpha1_BackupStatus_To_stash_BackupStatus(&in.Status, &out.Status, s); err != nil {
		return err
	}
	return nil
}

// Convert_v1alpha1_Backup_To_stash_Backup is an autogenerated conversion function.
func Convert_v1alpha1_Backup_To_stash_Backup(in *Backup, out *stash.Backup, s conversion.Scope) error {
	return autoConvert_v1alpha1_Backup_To_stash_Backup(in, out, s)
}

func autoConvert_stash_Backup_To_v1alpha1_Backup(in *stash.Backup, out *Backup, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	if err := Convert_stash_BackupSpec_To_v1alpha1_BackupSpec(&in.Spec, &out.Spec, s); err != nil {
		return err
	}
	if err := Convert_stash_BackupStatus_To_v1alpha1_BackupStatus(&in.Status, &out.Status, s); err != nil {
		return err
	}
	return nil
}

// Convert_stash_Backup_To_v1alpha1_Backup is an autogenerated conversion function.
func Convert_stash_Backup_To_v1alpha1_Backup(in *stash.Backup, out *Backup, s conversion.Scope) error {
	return autoConvert_stash_Backup_To_v1alpha1_Backup(in, out, s)
}

func autoConvert_v1alpha1_BackupList_To_stash_BackupList(in *BackupList, out *stash.BackupList, s conversion.Scope) error {
	out.ListMeta = in.ListMeta
	out.Items = *(*[]stash.Backup)(unsafe.Pointer(&in.Items))
	return nil
}

// Convert_v1alpha1_BackupList_To_stash_BackupList is an autogenerated conversion function.
func Convert_v1alpha1_BackupList_To_stash_BackupList(in *BackupList, out *stash.BackupList, s conversion.Scope) error {
	return autoConvert_v1alpha1_BackupList_To_stash_BackupList(in, out, s)
}

func autoConvert_stash_BackupList_To_v1alpha1_BackupList(in *stash.BackupList, out *BackupList, s conversion.Scope) error {
	out.ListMeta = in.ListMeta
	out.Items = *(*[]Backup)(unsafe.Pointer(&in.Items))
	return nil
}

// Convert_stash_BackupList_To_v1alpha1_BackupList is an autogenerated conversion function.
func Convert_stash_BackupList_To_v1alpha1_BackupList(in *stash.BackupList, out *BackupList, s conversion.Scope) error {
	return autoConvert_stash_BackupList_To_v1alpha1_BackupList(in, out, s)
}

func autoConvert_v1alpha1_BackupSpec_To_stash_BackupSpec(in *BackupSpec, out *stash.BackupSpec, s conversion.Scope) error {
...
// Convert_v1alpha1_BackupSpec_To_stash_BackupSpec is an autogenerated conversion function.
func Convert_v1alpha1_BackupSpec_To_stash_BackupSpec(in *BackupSpec, out *stash.BackupSpec, s conversion.Scope) error {
	return autoConvert_v1alpha1_BackupSpec_To_stash_BackupSpec(in, out, s)
}

func autoConvert_stash_BackupSpec_To_v1alpha1_BackupSpec(in *stash.BackupSpec, out *BackupSpec, s conversion.Scope) error {
	out.Selector = in.Selector
...
// Convert_stash_BackupSpec_To_v1alpha1_BackupSpec is an autogenerated conversion function.
func Convert_stash_BackupSpec_To_v1alpha1_BackupSpec(in *stash.BackupSpec, out *BackupSpec, s conversion.Scope) error {
	return autoConvert_stash_BackupSpec_To_v1alpha1_BackupSpec(in, out, s)
}

func autoConvert_v1alpha1_BackupStatus_To_stash_BackupStatus(in *BackupStatus, out *stash.BackupStatus, s conversion.Scope) error {
...
// Convert_v1alpha1_BackupStatus_To_stash_BackupStatus is an autogenerated conversion function.
func Convert_v1alpha1_BackupStatus_To_stash_BackupStatus(in *BackupStatus, out *stash.BackupStatus, s conversion.Scope) error {
	return autoConvert_v1alpha1_BackupStatus_To_stash_BackupStatus(in, out, s)
}

func autoConvert_stash_BackupStatus_To_v1alpha1_BackupStatus(in *stash.BackupStatus, out *BackupStatus, s conversion.Scope) error {
	out.FirstBackupTime = (*meta_v1.Time)(unsafe.Pointer(in.FirstBackupTime))
	out.LastBackupTime = (*meta_v1.Time)(unsafe.Pointer(in.LastBackupTime))
	out.LastSuccessfulBackupTime = (*meta_v1.Time)(unsafe.Pointer(in.LastSuccessfulBackupTime))
	out.LastBackupDuration = in.LastBackupDuration
...
// Convert_stash_BackupStatus_To_v1alpha1_BackupStatus is an autogenerated conversion function.
func Convert_stash_BackupStatus_To_v1alpha1_BackupStatus(in *stash.BackupStatus, out *BackupStatus, s conversion.Scope) error {
	return autoConvert_stash_BackupStatus_To_v1alpha1_BackupStatus(in, out, s)
}
