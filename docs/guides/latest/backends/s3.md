...
Stash supports AWS S3 or S3 compatible storage services like [Minio](https://minio.io/) servers, [Rook Object Store](https://rook.io/docs/rook/v0.9/ceph-object.html), [DigitalOceans Space](https://www.digitalocean.com/products/spaces/) as backend. This tutorial will show you how to use this backend.
...
Below, the YAML of a sample `Repository` crd that uses an `S3` bucket as backend.
