...
func RegisterConversions(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedConversionFuncs(
		...
		Convert_v1alpha1_RecoveryVolume_To_stash_RecoveryVolume,
		Convert_stash_RecoveryVolume_To_v1alpha1_RecoveryVolume,
...
func autoConvert_v1alpha1_RecoverySpec_To_stash_RecoverySpec(in *RecoverySpec, out *stash.RecoverySpec, s conversion.Scope) error {
	...
	out.RecoveryVolumes = *(*[]stash.RecoveryVolume)(unsafe.Pointer(&in.RecoveryVolumes))
	return nil
}
...
func autoConvert_stash_RecoverySpec_To_v1alpha1_RecoverySpec(in *stash.RecoverySpec, out *RecoverySpec, s conversion.Scope) error {
	...
	out.PodOrdinal = in.PodOrdinal
	out.NodeName = in.NodeName
	out.RecoveryVolumes = *(*[]RecoveryVolume)(unsafe.Pointer(&in.RecoveryVolumes))
	return nil
}
...
func autoConvert_v1alpha1_RecoveryVolume_To_stash_RecoveryVolume(in *RecoveryVolume, out *stash.RecoveryVolume, s conversion.Scope) error {
	out.Name = in.Name
	out.VolumeSource = in.VolumeSource
...
// Convert_v1alpha1_RecoveryVolume_To_stash_RecoveryVolume is an autogenerated conversion function.
func Convert_v1alpha1_RecoveryVolume_To_stash_RecoveryVolume(in *RecoveryVolume, out *stash.RecoveryVolume, s conversion.Scope) error {
	return autoConvert_v1alpha1_RecoveryVolume_To_stash_RecoveryVolume(in, out, s)
}

func autoConvert_stash_RecoveryVolume_To_v1alpha1_RecoveryVolume(in *stash.RecoveryVolume, out *RecoveryVolume, s conversion.Scope) error {
	out.Name = in.Name
	out.VolumeSource = in.VolumeSource
	out.MountPath = in.MountPath
	out.SubPath = in.SubPath
...
// Convert_stash_RecoveryVolume_To_v1alpha1_RecoveryVolume is an autogenerated conversion function.
func Convert_stash_RecoveryVolume_To_v1alpha1_RecoveryVolume(in *stash.RecoveryVolume, out *RecoveryVolume, s conversion.Scope) error {
	return autoConvert_stash_RecoveryVolume_To_v1alpha1_RecoveryVolume(in, out, s)
}
