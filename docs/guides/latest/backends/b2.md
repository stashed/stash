...
Stash supports Backblaze's [B2 Cloud Storage](https://www.backblaze.com/b2/cloud-storage.html) as backend. This tutorial will show you how to use this backend.
...
Below, the YAML of a sample `Repository` crd that uses a B2 bucket as backend.
