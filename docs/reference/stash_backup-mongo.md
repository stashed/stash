---
title: Stash Backup-Mongo
menu:
  product_stash_0.8.3:
    identifier: stash-backup-mongo
    name: Stash Backup-Mongo
    parent: reference
product_name: stash
