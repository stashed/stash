...
func convert_to_extensions_daemonset(gv schema.GroupVersion, raw []byte) (*extensions_v1beta1.DaemonSet, runtime.Object, error) {
	switch gv {
	case v1.SchemeGroupVersion:
		...
		extObj := &extensions_v1beta1.DaemonSet{}
