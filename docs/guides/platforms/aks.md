...
<p align="center">
  <img alt="Repository in Azure Backend",  height="350px" src="/images/platforms/aks/azure-backup-repository.png">
</p>

To view the snapshot files, navigate to `snapshots` directory of the repository,

<p align="center">
  <img alt="Snapshot in Azure Bucket" height="350px" src="/images/platforms/aks/azure-backup-snapshots.png">
</p>
