...
type RepositoryInterface interface {
	Create(*v1beta1.Repository) (*v1beta1.Repository, error)
	Update(*v1beta1.Repository) (*v1beta1.Repository, error)
	UpdateStatus(*v1beta1.Repository) (*v1beta1.Repository, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1beta1.Repository, error)
	List(opts v1.ListOptions) (*v1beta1.RepositoryList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.Repository, err error)
	RepositoryExpansion
}
...
func newRepositories(c *StashV1beta1Client, namespace string) *repositories {
	return &repositories{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *repositories) Get(name string, options v1.GetOptions) (result *v1beta1.Repository, err error) {
	result = &v1beta1.Repository{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *repositories) List(opts v1.ListOptions) (result *v1beta1.RepositoryList, err error) {
	result = &v1beta1.RepositoryList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("repositories").
...
func (c *repositories) Create(repository *v1beta1.Repository) (result *v1beta1.Repository, err error) {
	result = &v1beta1.Repository{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("repositories").
...
func (c *repositories) Update(repository *v1beta1.Repository) (result *v1beta1.Repository, err error) {
	result = &v1beta1.Repository{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("repositories").
...
func (c *repositories) UpdateStatus(repository *v1beta1.Repository) (result *v1beta1.Repository, err error) {
	result = &v1beta1.Repository{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("repositories").
...
func (c *repositories) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.Repository, err error) {
	result = &v1beta1.Repository{}
