...
|--------------------------------------------------------------------------|-----------------------------------------------------------------------|--------------------|
| [0.5.0-beta.3](https://github.com/appscode/stash/releases/tag/0.5.0-beta.3) (uses CRD) | [User Guide](https://github.com/appscode/stash/tree/0.5.0-beta.3/docs) | 1.7.x+             |
