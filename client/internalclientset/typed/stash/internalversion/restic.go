...
type ResticInterface interface {
	Create(*stash.Restic) (*stash.Restic, error)
	Update(*stash.Restic) (*stash.Restic, error)
	UpdateStatus(*stash.Restic) (*stash.Restic, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*stash.Restic, error)
	List(opts v1.ListOptions) (*stash.ResticList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *stash.Restic, err error)
	ResticExpansion
}
...
func newRestics(c *StashClient, namespace string) *restics {
	return &restics{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *restics) Get(name string, options v1.GetOptions) (result *stash.Restic, err error) {
	result = &stash.Restic{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("restics").
...
func (c *restics) List(opts v1.ListOptions) (result *stash.ResticList, err error) {
	result = &stash.ResticList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("restics").
...
func (c *restics) Create(restic *stash.Restic) (result *stash.Restic, err error) {
	result = &stash.Restic{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("restics").
...
func (c *restics) Update(restic *stash.Restic) (result *stash.Restic, err error) {
	result = &stash.Restic{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("restics").
...
func (c *restics) UpdateStatus(restic *stash.Restic) (result *stash.Restic, err error) {
	result = &stash.Restic{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("restics").
...
func (c *restics) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *stash.Restic, err error) {
	result = &stash.Restic{}
