...
type RepositoryInformer interface {
	...
	Lister() v1beta1.RepositoryLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.StashV1beta1().Repositories(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.StashV1beta1().Repositories(namespace).Watch(options)
			},
		},
		&stashv1beta1.Repository{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *repositoryInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&stashv1beta1.Repository{}, f.defaultInformer)
}

func (f *repositoryInformer) Lister() v1beta1.RepositoryLister {
	return v1beta1.NewRepositoryLister(f.Informer().GetIndexer())
}
