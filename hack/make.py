...
def fmt():
    libbuild.ungroup_go_imports('api', 'client', 'cmd', 'pkg', 'test')
    die(call('goimports -w api client cmd pkg test'))
    call('gofmt -s -w api client cmd pkg test')


def vet():
    call('go vet ./api/... ./client/... ./cmd/... ./pkg/... ./test/...')
