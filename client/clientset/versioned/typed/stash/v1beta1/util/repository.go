...
func CreateOrPatchRepository(c cs.StashV1beta1Interface, meta metav1.ObjectMeta, transform func(in *api.Repository) *api.Repository) (*api.Repository, kutil.VerbType, error) {
