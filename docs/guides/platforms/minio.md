...
Now, we will create `Restic` crd to take backup `/source/data` directory of `stash-demo` deployment. This will create a repository in the Minio bucket specified in `s3.bucket` field and start taking periodic backup of `/source/data` directory.
...
metadata:
  annotations:
    kubectl.kubernetes.io/last-applied-configuration: |
      {"apiVersion":"stash.appscode.com/v1alpha1","kind":"Recovery","metadata":{"annotations":{},"name":"minio-recovery","namespace":"demo"},"spec":{"paths":["/source/data"],"recoveredVolumes":[{"mountPath":"/source/data","persistentVolumeClaim":{"claimName":"stash-recovered"}}],"repository":{"name":"deployment.stash-demo","namespace":"demo"}}}
  creationTimestamp: 2018-12-05T12:08:03Z
  generation: 1
  name: minio-recovery
  namespace: demo
  resourceVersion: "39165"
  selfLink: /apis/stash.appscode.com/v1alpha1/namespaces/demo/recoveries/minio-recovery
  uid: 6ab519e0-f886-11e8-9a81-0800272171a4
spec:
  paths:
  - /source/data
  recoveredVolumes:
...
- If you have deployed Minio server by following the tutorial we have linked in [Before You Begin](/docs/guides/platforms/minio.md#before-you-begin) section, please clean-up Minio resources following the [cleanup](https://github.com/appscode/third-party-tools/blob/master/storage/minio/README.md#cleanup) section of that tutorial.